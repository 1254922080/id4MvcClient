...
namespace Id4ClientCodeDemo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.DefaultScheme = "Cookies";//使用cookie来本地登录用户
                options.DefaultChallengeScheme = "oidc";//当用户登录时，我们将使用OpenID Connect协议
            })
                ...
                .AddOpenIdConnect("oidc", options =>//用于配置执行OpenID Connect协议的处理程序。
                {
                    ...
                    options.SaveTokens = true;//用于将IdentityServer中的令牌持久保存在cookie中
                });
        }
